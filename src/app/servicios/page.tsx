                ...
                >
                  <Card className="overflow-hidden p-0">
                    <div className={`grid md:grid-cols-2 gap-0 ${!isEven ? "md:flex-row-reverse" : ""}`}>
                      {/* Image Side */}
                      <div className={`relative min-h-[280px] md:min-h-[400px] ${!isEven ? "md:order-2" : ""}`}>
                        <Image
                          src={service.image}
                        ...
                        <div className="absolute bottom-4 left-4 flex items-center gap-3">
                          <div className="flex items-center gap-2 bg-white/95 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                            ...
                            <span className="text-sm font-medium text-neutral-700">{service.duration}</span>
                          </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-primary-100 text-lg mb-8 max-w-2xl mx-auto">
              Contáctanos y te asesoraremos sobre el tratamiento más adecuado para tu caso.
            </p>
