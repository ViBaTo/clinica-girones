        ...
        <div className='container-custom'>
          ...
          >
            ...
            <p className='text-lg text-neutral-600 leading-relaxed'>
              Estamos aquí para atenderte. Contacta con nosotros y te
            ...
            >
              ...
              <Card className='p-6'>
                ...
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className='flex items-start gap-3 mb-4 hover:text-primary transition-colors'
                >
                  <MapPin className='w-5 h-5 text-primary flex-shrink-0 mt-1' />
                  <div>
                    <p className='text-neutral-700 hover:text-primary'>
                ...
                <ul className='space-y-2'>
                  {CLINIC_INFO.hours.map((schedule, index) => (
                    ...
                    >
                      ...
                      <span
                        className={`font-medium ${schedule.hours === 'Cerrado' ? 'text-red-500' : 'text-neutral-900'}`}
                      >
                        {schedule.hours}
                      </span>
                    </li>
