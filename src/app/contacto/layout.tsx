...
export const metadata: Metadata = {
  title: "Contacto",
  description: `Contacta con ${CLINIC_INFO.name}. Pide tu cita de podología en València. Teléfono: ${CLINIC_INFO.phone}. Dirección: ${CLINIC_INFO.address.street}, ${CLINIC_INFO.address.floor}, ${CLINIC_INFO.address.city}.`,
  openGraph: {
