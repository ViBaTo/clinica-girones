...
import { Menu, X, Phone, ChevronDown, Footprints, Hand, Heart, Dumbbell } from "lucide-react";
    ...
    >
      <nav className="container-custom">
        <div className="flex items-center justify-between">
          ...
          >
            <Logo size="md" className="text-neutral-900 group-hover:text-primary transition-colors" />
          </Link>
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname === link.href || pathname.startsWith("/servicios")
                          ? "text-primary"
                          ...
                          <div className="bg-white rounded-2xl shadow-lg border border-neutral-100 p-4 min-w-[280px]">
                            <div className="space-y-1">
                              {SERVICES.map((service) => {
                                const Icon = serviceIconMap[service.icon] || Footprints;
                                return (
                                  <Link
                                    key={service.id}
