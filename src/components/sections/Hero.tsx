        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.span
              ...
              className="inline-block text-primary font-medium text-sm uppercase tracking-wider mb-4 bg-primary-light px-4 py-2 rounded-full"
            >
              Clínica de Podología en València
            </motion.span>
            ...
            >
              Cuidamos tus pies,{" "}
              <span className="text-primary">mejoramos tu vida</span>
            </motion.h1>
            ...
            >
              Más de 15 años de experiencia en tratamientos podológicos personalizados. 
              Tu bienestar comienza por unos pies sanos.
            </motion.p>
            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-neutral-900 text-sm">Citas disponibles</p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-neutral-600">
                    <span className="font-semibold text-neutral-900">+200</span> pacientes este mes
                  </p>
                </div>
              </motion.div>
            </div>
